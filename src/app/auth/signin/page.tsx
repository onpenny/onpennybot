        ...
        <CardHeader className="space-y-1 pb-8">
          <div className="text-center">
            <div className="inline-block mb-4">
              <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-3xl font-bold px-6 py-2 rounded-xl shadow-md">
                OnHeritage
              </div>
            </div>
        ...
        <CardContent>
          ...
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
              <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77c0-2.86-0.78-5.29-1.04-4.74h3.57c2.86-0 5.29-1.93 6.16-4.53h-3.57c-1.93 0-4.74.78-1.04v-2.77c0-.78.07-1.53-.2-2.25H12z" />
            </svg>
